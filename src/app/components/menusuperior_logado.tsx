        ...
        <div className={styles.menusuperior}>
            ...
            <nav className={styles.menu_opcoes} aria-label="Menu superior">
                <ul className={styles.logado}>
                    ...
                    <li><Link href="../pages/configuracoes" aria-label="Ir para configurações de Perfil" className={styles.btnPerfil}><Image src="/images/perfil.png" className={styles.icon_pesquisa} alt="Ícone de pesquisa" width={100} height={100} priority /><span>Karine Sousa</span></Link></li>
                </ul>
            </nav>
        </div>
    );
